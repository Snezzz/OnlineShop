/**
 * Created by Снежа on 02.12.2017.
 */
$('document').ready(function() {
    ...
    var webAuth = new auth0.WebAuth({
        domain: 'snezzz.eu.auth0.com',
        clientID: 'ZeOVz3mFJneyBAnyNlZvTaDWGiqDnPu6',
        redirectUri: 'http://localhost:63342/web/index.html',
        audience: 'https://' +'snezzz.eu.auth0.com' + '/userinfo',
...
//отображение данных пользователя
    ...
    function displayButtons() {
        ...
        if (isAuthenticated()) {
            ...
            profileViewBtn.css('visibility','visible');
            loginStatus.text(
                'You are logged in!'
            );
        } else {
